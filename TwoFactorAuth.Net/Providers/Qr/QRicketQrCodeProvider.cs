...
public class QRicketQrCodeProvider : BaseHttpQrCodeProvider, IQrCodeProvider
{
    ...
    /// </summary>
    private static readonly Uri _baseuri = new("http://qrickit.com/api/qr");
    ...
    {
        QRicketImageFormat.Png => "image/png",
        QRicketImageFormat.Gif => "image/gif",
        QRicketImageFormat.Jpeg => "image/jpeg",
